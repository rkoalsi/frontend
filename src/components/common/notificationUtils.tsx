...
export const TYPE_ACCENT_COLORS: Record<string, string> = {
  ...
  return_order_status: '#D9534F',
  customer_request_submitted: '#C2417F',
  customer_request_status: '#C2417F',
  customer_request_comment: '#C2417F',
  customer_request_reply: '#C2417F',
  daily_visit_created: '#A796FF',
  daily_visit_updated: '#A796FF',
  daily_visit_comment: '#A796FF',
  new_training: '#64b5f6',
  new_announcement: '#ffb74d',
  shipment_dispatched: '#6A5AD1',
  shipment_delivered: '#66bb6a',
  estimate_accepted: '#66bb6a',
  draft_sales_order: '#64b5f6',
  draft_invoice: '#C2417F',
  new_product: '#6A5AD1',
...
const ICONS: Record<string, React.ReactElement> = {
  ...
  return_order_status: <AssignmentReturnOutlined fontSize='small' />,
