...
import {
  ...
  accentTile,
  cardSx,
} from '../src/components/marketing/marketplace';

// The full public marketing page. Hero, features and the closing CTA are shared
// with the logged-out root (`pages/index.tsx`) via src/components/marketing so
// the copy can never drift between the two; everything below — brands, steps,
// buyer types, categories and the FAQ — is unique to this page.
